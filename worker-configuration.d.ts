/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 36617a10fbcabfa4ab81c1ace630a9c8)
...
declare namespace Cloudflare {
	...
	interface Env {
		VETAPP_ACCOUNT_ADDRESS: string;
		APTOS_PRIVATE_KEY: string;
		VITE_APTOS_API_KEY: string;
		PROJECT_NAME: string;
		VITE_APP_NETWORK: string;
		VITE_MODULE_TAPP_ACCOUNT_ADDRESS: string;
		VITE_MODULE_VETAPP_ACCOUNT_ADDRESS: string;
		VITE_MODULE_VETAPP_LIB_ACCOUNT_ADDRESS: string;
		VITE_MODULE_GAUGE_ACCOUNT_ADDRESS: string;
		VITE_MODULE_ESCROW_ACCOUNT_ADDRESS: string;
		VITE_MODULE_BONDING_CURVE_ACCOUNT_ADDRESS: string;
		VITE_MODULE_NFT_SPRINGBOARD_ACCOUNT_ADDRESS: string;
		VITE_MODULE_AMM_ACCOUNT_ADDRESS: string;
		VITE_MODULE_CLMM_ACCOUNT_ADDRESS: string;
		VITE_MODULE_STABLE_ACCOUNT_ADDRESS: string;
	}
}
